...
describe("UserService", () => {
  ...
  describe("getUsers", () => {
    ...
    it("should fetch users with both role and namespace filters", async () => {
      ...
      expect(mockFetch).toHaveBeenCalledWith(
        "/api/users?role=Developer&namespace=default",
        {
          method: "GET",
          headers: { "Content-Type": "application/json" },
        }
  ...
  describe("activateUser", () => {
    ...
    it("should handle activation errors", async () => {
      ...
      await expect(UserService.activateUser("999")).rejects.toThrow(
        "User not found"
      );
    });
  });
  ...
  describe("deactivateUser", () => {
    ...
    it("should handle deactivation errors", async () => {
      ...
      await expect(UserService.deactivateUser("999")).rejects.toThrow(
        "User not found"
      );
    });
  });
  ...
  describe("bulkUpdateUsers", () => {
    ...
    it("should handle bulk update errors", async () => {
      ...
      await expect(UserService.bulkUpdateUsers(bulkUpdate)).rejects.toThrow(
        "Validation error"
      );
    });
  });
